      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_1fr]">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <ToggleRow
              label="Show explanation time on analytics"
              description="Hide or show explanation-based timing boxes across analytics screens."
              checked={settings.showExplanationTime}
              onChange={(checked) => setSettings((current) => ({ ...current, showExplanationTime: checked }))}
            />
