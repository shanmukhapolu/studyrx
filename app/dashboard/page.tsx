        ...
        <AuthGuard>
          ...
          <div className="flex flex-col flex-1">
            ...
            <main className="flex-1 p-6 space-y-6">
              <div className="rounded-2xl glass-card tech-border p-5 bg-gradient-to-r from-primary/10 via-secondary/5 to-transparent">
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              ...
              <Card className="glass-card tech-border bg-gradient-to-br from-secondary/10 to-transparent h-fit">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
